...
function Projects() {
  return (
    <div
      className="flex flex-col content-center w-full relative min-h-screen mt-1"
      id="proyectos"
    >
      <h2 className="absolute text-textoAtras text-[400px] right-0 pointer-events-none">
        Projects
      </h2>
      <div className="ml-20 flex flex-col justify-center content-center z-10 w-1/4 aniacion1">
        <h1
        ...
        <p
          className="w-full italiano text-xl text-white before:content-['<p>'] before:text-3xl before:text-oculto flex flex-col after:content-['</p>'] after:text-3xl after:text-oculto after:my-3 before:my-3 after:-ml-5 before:-ml-5 z-10 "
          data-aos="fade-right"
