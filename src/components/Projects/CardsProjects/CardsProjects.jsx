...
function CardsProjects({ imagen, title, desc, tecnologias, link }) {
  ...
  return (
    <div className="relative w-[500px] h-[300px] mt-3 mb-20" onMouseLeave={mostrar()}>
      <img
        src={imagen}
        alt="Imagen Portada"
        className="rounded-2xl w-full h-full"
      />
      <div className="hidden descripcion">
        ...
        <div className="bg-textoAtras rounded-b-2xl p-5 text-white text-center h-20 absolute -bottom-16 w-full z-20 flex justify-center">
