  ...
  return (
    <div className="text-white relative w-full min-h-screen">
      ...
      <div className="ml-20 flex flex-col justify-center content-center h-screen pointer-events-auto animacion1">
        ...
        <p className="italiano text-xl text-textoGris before:content-['<p>'] before:text-3xl before:text-oculto flex flex-col after:content-['</p>'] after:text-3xl after:text-oculto after:my-3 before:my-3 after:-ml-5 before:-ml-5 z-20 animacion2" data-aos="fade-right" data-aos-duration="2000">
          Estudiante de Ingeniería y desarrollador web
        </p>
        <a
          className="border border-celeste p-3 text-xl w-40 text-center mt-3 after:content-[''] after:block after:bg-celeste relative after:absolute after:w-1 after:h-1 after:right-0 after:bottom-0 before:content-[''] before:block before:bg-celeste before:absolute before:w-1 before:h-1 before:left-0 before:top-0 hover:bg-celeste text-celeste hover:text-black transition ease-in-out delay-75 z-20 pointer-events-auto animacion3" data-aos="fade-up" data-aos-duration="3000"
          href="#contacto"
        >
          Contactame!
        </a>
