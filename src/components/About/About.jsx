...
function About() {
  return (
    ...
    >
      ...
      <div className="ml-20 flex flex-col justify-center content-center h-screen w-1/3 animacion1">
        <h1 className="w-full text-celeste py-14 text-7xl relative before:absolute before:content-['<h2>'] before:text-3xl before:text-oculto before:top-0 before:left-0 after:bottom-0 after:left-0  after:absolute after:content-['</h2>'] after:text-3xl after:text-oculto after:my-3 before:mb-3 font-bold after:font-normal before:font-normal after:-ml-5 before:-ml-5 h-52 italiano z-10" data-aos="fade-right" data-aos-duration="1000">
          Sobre mí
        </h1>
        <p className="w-full italiano text-xl text-white before:content-['<p>'] before:text-3xl before:text-oculto flex flex-col after:content-['</p>'] after:text-3xl after:text-oculto after:my-3 before:my-3 after:-ml-5 before:-ml-5 z-10 animacion2" data-aos="fade-right" data-aos-duration="2000">
      ...
      <div className="w-2/3 flex flex-col justify-center content-center animacion4" data-aos="zoom-in" data-aos-duration="2000">
        <TagCloud
