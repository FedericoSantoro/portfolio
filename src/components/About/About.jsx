...
function About() {
  return (
    <div
      className="flex flex-row content-center justify-center w-full relative min-h-screen mt-1"
      id="sobreMi"
    >
      ...
      <div className="ml-20 flex flex-col justify-center content-center h-screen w-1/3 ">
        ...
        <p className="w-full italiano text-xl text-white before:content-['<p>'] before:text-3xl before:text-oculto flex flex-col after:content-['</p>'] after:text-3xl after:text-oculto after:my-3 before:my-3 after:-ml-5 before:-ml-5 z-10 " data-aos="fade-right" data-aos-duration="2000">
      ...
      <div className="w-2/3 flex flex-col justify-center content-center" data-aos="zoom-in" data-aos-duration="2000">
        <TagCloud
